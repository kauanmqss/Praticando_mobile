...
export function AdminScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button mode="contained" onPress={cadastrarItem} style={styles.botoes}>
        Adicionar Item
      </Button>
    </View>
  );
...
export function RelatorioScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{ marginTop: 10, fontSize: 18 }}>Total de itens: {totalItens}</Text>
      <Text style={{ fontSize: 18 }}>Soma de preços: R$ {totalPreco.toFixed(2)}</Text>
